...
from models.claude import Claude, ClaudeOpus, ClaudeSonnet, ClaudeHaiku
...
class MetaAnalysisTaskRunner:
    ...
    def __load_prompt_template(self) -> str:
        ...
        if "gpt" in self.model_name:
            ...
            self.prompt_template = self.task + "/gpt"  # Use GPT template for Claude
        elif "gemini" in self.model_name:
            self.prompt_template = self.task + "/gpt"  # Use GPT template for Gemini
        elif "llama3" in self.model_name:
            self.prompt_template = self.task + "/llama3"  # Use Llama 3 template
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", default="gpt35",
                        choices=["gpt35", "gpt4", "mistral7B", "biomistral", "pmc-llama",
                        ...
                        help="what model to run", required=True)
